  ...
  <?php if ($kind === 'locations'): ?>
    ...
    <label class="span-3">Slug
      <span class="url-field">
        ...
        <input name="item[cityKey]" value="<?php echo html_escape($item['cityKey']); ?>" />
      </span>
      <span class="file-note">The /locations/ part stays fixed. Type the slug, or leave it blank to build it from the name.</span>
    </label>
  ...
  <?php else: ?>
    ...
    <label class="span-3">Slug
      <span class="url-field">
        ...
        <input name="item[categoryKey]" value="<?php echo html_escape($item['categoryKey']); ?>" />
      </span>
      <span class="file-note">The /projects/ part stays fixed. Type the slug, or leave it blank to build it from the name.</span>
    </label>
