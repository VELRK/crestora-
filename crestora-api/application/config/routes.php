...
$route['api/projects/(:any)/similar'] = 'api/similar/$1';
$route['api/projects/(:any)'] = 'api/project/$1';
$route['api/categories'] = 'api/categories';
$route['api/locations'] = 'api/locations';
$route['api/about'] = 'api/about';
$route['api/blogs'] = 'api/blogs';
$route['api/blogs/(:any)'] = 'api/blog/$1';
$route['api/contact'] = 'api/contact';
$route['api/filters'] = 'api/filters';
$route['api/enquiries'] = 'api/enquiries';
$route['api/site-visits'] = 'api/site_visits';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
